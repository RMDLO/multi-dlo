...
if __name__=='__main__':
    ...
    # test camera pose
    trans_5 = [0.39002629499422226, 0.030955664080618457, 0.3274715024450317]
    quat_5 = [-0.7063672001370509, 0.7074835174273736, 0.019360757833288222, 0.011730822445838193]
